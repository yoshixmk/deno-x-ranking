...
const Header = ({ config, language, isDark, setIsDark }) => {
    ...
    return (React.createElement("header", null,
        React.createElement("h1", { className: "hide_on_mobile" },
            React.createElement("a", { href: language === ((_a = config.i18n) === null || _a === void 0 ? void 0 : _a.languages[0].code)
                    ? config.root
                    : `${config.root}${language}/` }, config.title)),
        React.createElement("nav", null,
            React.createElement("ul", null,
                React.createElement("li", { className: "show_on_mobile flex_center" },
                    React.createElement("a", { className: "czs-menu-l", href: "#", style: {
                ...
                _b.filter(({ align }) => align !== "right").map(({ text, link, target, popover }) => (React.createElement("li", { key: link, className: "hide_on_mobile" }, popover
                    ? (React.createElement(Popover, { placement: "bottom-start", content: popover },
                        React.createElement("a", { href: link, target: target }, text)))
                    : (React.createElement("a", { href: link, target: target }, text))))),
                React.createElement("li", { style: { flexGrow: 1 } }), (_c = config.nav) === null || _c === void 0 ? void 0 :
                _c.filter(({ align }) => align === "right").map(({ text, link, target, popover }) => (React.createElement("li", { key: link, className: "hide_on_mobile" }, popover
                    ? (React.createElement(Popover, { placement: "bottom-end", content: popover },
                        React.createElement("a", { href: link, target: target }, text)))
                    : (React.createElement("a", { href: link, target: target }, text))))),
                config.github && (React.createElement("li", { className: "flex_center" },
                    React.createElement("a", { className: "czs-github-logo", href: config.github, target: "_blank", style: {
                            backgroundImage: `url("${config.root}assets/czs-github-logo.svg")`,
                        } }))),
                ...
                React.createElement("li", { onClick: () => {
                    ...
                    React.createElement("span", { className: "czs-sun", style: {
                            backgroundImage: `url("${config.root}assets/czs-sun.svg")`,
                        } }),
                    React.createElement("span", { className: "czs-sun-l", style: {
                            backgroundImage: `url("${config.root}assets/czs-sun-l.svg")`,
                        } }),
                    React.createElement("span", { className: "czs-moon", style: {
                            backgroundImage: `url("${config.root}assets/czs-moon.svg")`,
                        } }),
                    React.createElement("span", { className: "czs-moon-l", style: {
