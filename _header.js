    ...
    React.createElement("nav", null,
        React.createElement("ul", null,
            ...
            React.createElement("li", { className: "mobile_menu flex_center" },
                React.createElement("a", { className: "czs-menu-l", href: "#", style: { backgroundImage: `url("${config.base}assets/czs-menu-l.svg")` }, onClick: (e) => {
                        e.preventDefault();
                        // @ts-ignore
            ...
            config.github && (React.createElement("li", { className: "flex_center" },
                React.createElement("a", { className: "czs-github-logo", href: config.github, target: "_blank", style: { backgroundImage: `url("${config.base}assets/czs-github-logo.svg")` } }))),
