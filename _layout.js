    ...
    return (React.createElement("html", { className: classnames({ is_dark: isDark }) },
        ...
        React.createElement("body", null,
            ...
            config.tools && (React.createElement("div", { className: "tools flex_center" },
                config.tools.editOnGithub && (React.createElement("a", { className: "czs-pen button", href: `${config.github}/edit/master/${props.pagePath}`, target: "_blank", style: { backgroundImage: `url("${config.base}assets/czs-pen.svg")` } })),
